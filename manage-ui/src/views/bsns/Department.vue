<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="companyName" label="公司名" width="150" align="center"/>

      <el-table-column prop="hrName" label="招聘HR" width="250" align="center"/>
...
const initRoleList = async ()=> {
  const result = await requestUtil.post(`sys/department/list`, queryForm.value)
...
const handleDelete=async (id)=>{
  ...
  const res=await requestUtil.post("sys/department/delete",ids)
